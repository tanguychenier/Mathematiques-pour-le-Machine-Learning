...
> **Que sont ces trois outils ? (chacun est repris en détail dans son chapitre)**
> - La **décomposition en valeurs singulières (SVD)** déplie n'importe quelle matrice en trois gestes simples : une rotation, un étirement le long de quelques axes, puis une autre rotation. Ces axes et ces facteurs d'étirement révèlent les directions vraiment importantes cachées dans la matrice.
> - L'**analyse en composantes principales (ACP)** cherche les quelques directions dans lesquelles les données s'étalent le plus, pour les résumer avec beaucoup moins de nombres sans perdre l'essentiel. C'est comme décrire une foule par « surtout étalée en hauteur, un peu en largeur » plutôt que de donner la position de chaque personne.
> - Une **valeur propre** est le facteur par lequel une transformation étire une direction qu'elle ne fait pas tourner (cette direction privilégiée s'appelle un *vecteur propre*). Si une direction est multipliée par 2 sans changer d'orientation, sa valeur propre vaut 2. Regarder ces facteurs dit si un système amplifie ou amortit ce qu'on lui donne, donc s'il reste stable.
